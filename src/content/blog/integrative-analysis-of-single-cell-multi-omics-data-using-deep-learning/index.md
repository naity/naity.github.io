---
title: "Integrative analysis of single-cell multi-omics data using deep learning (with video tutorials)"
date: 2019-09-14
description: "An autoencoder-based tutorial (with videos) for integrative analysis of CITE-seq single-cell gene and protein expression data."
tags: ["Deep Learning", "Machine Learning", "Autoencoder"]
cover: ./featured-image.png
---

## Video tutorial #1:

<div class="aspect-video"><iframe src="https://www.youtube-nocookie.com/embed/tad9TPCMWbU" title="Video tutorial #1: Integrative analysis of single-cell multi-omics data" loading="lazy" allowfullscreen class="h-full w-full rounded-lg"></iframe></div>

## Video tutorial #2:

<div class="aspect-video"><iframe src="https://www.youtube-nocookie.com/embed/sRpj9MhNjS8" title="Video tutorial #2: Integrative analysis of single-cell multi-omics data" loading="lazy" allowfullscreen class="h-full w-full rounded-lg"></iframe></div>
...
![Overview of CITE-seq](citeseq.jpg)
...
[View the preprocessing code on GitHub Gist →](https://gist.github.com/naity/10951c280955a992a23899a5f5806a83)
...
*Image source: Eraslan et al. Nat Rev Genet. 2019*
...
![Autoencoder architecture for CITE-seq data](autoencoder_arch.png)
...
[View the autoencoder code on GitHub Gist →](https://gist.github.com/naity/cc8c8f694fb318fd1a5d1cb60f2b5f8b)
...
![t-SNE visualization based on gene expression only](gene_only.jpeg)
*Visualization based on gene expression data only. The red arrow points at CD8 T cells.*

![t-SNE visualization based on gene and protein expression](gene_protein.png)
*Visualization based on both gene and protein expression data. The red arrow points at CD8 T cells.*
