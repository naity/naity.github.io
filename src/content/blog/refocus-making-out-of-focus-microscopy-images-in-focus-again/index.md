---
title: "ReFocus: Making Out-of-Focus Microscopy Images In-Focus Again"
date: 2019-04-22
description: "Training a U-net with feature loss to turn out-of-focus microscopy images into in-focus ones using fastai."
tags: ["Deep Learning", "Machine Learning", "Convolutional Neural Network"]
...
![In-focus and out-of-focus microscopy images side by side](examples.png)
...
![U-net-based architecture](unet.png)
...
![Schematic of feature loss](feature_loss.png)
...
![Model performance on the validation sets](result.png)
...
![Model performance on the test set at z = 32](result2.png)
