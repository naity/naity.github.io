...
![Example images of benign versus malignant skin lesions](benign_vs_malignant.png)

As mentioned above, there are metadata available in addition to the images as shown below:

![Metadata as a Pandas dataframe](metadata.png)
...
![Bar charts showing metadata features associated with the target](bar.png)
...
![Joint network architecture](arch.png)
*Figure from N. Gessert, M. Nielsen, and M. Shaikh et al. / MethodsX 7 (2020) 100864*
...
![Kaggle public score](kaggle.png)
